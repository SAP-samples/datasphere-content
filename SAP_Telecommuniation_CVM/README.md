# SAP Datasphere SAP Telecommunication: Customer Value Management (CVM) business content - DDL SQL statements for the tables in the open SQL schema and sample data
