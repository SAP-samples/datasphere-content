# SAP Data Warehouse Cloud Content - Samples data set for SAP Retail: POS Analytics package
...
Download the ZIP file (dwc_retail_pos_samples_csv.zip.zip) from the [release page](https://github.com/SAP-samples/data-warehouse-cloud-content-beta/releases). The ZIP files contains the CSV files.
